...
public class ShortestJobFirst extends Scheduler {
    int numProcesses;
    Queue<Process> readyQueue = new PriorityQueue<>(new ProcessJobLengthComparator());
    Queue<Process> waitingQueue = new PriorityQueue<>(new ProcessJobLengthComparator());
...
class ProcessJobLengthComparator implements Comparator<Process> {
    @Override
